...
typedef struct IEcoLab1VTbl {
    ...
    /* Сортировка расческой (comb sort) для разных типов данных */
    int16_t (ECOCALLMETHOD *csort_int)(/* in */ IEcoLab1Ptr_t me, /* in */ int32_t* array, /* in */ uint32_t size);
    int16_t (ECOCALLMETHOD *csort_long)(/* in */ IEcoLab1Ptr_t me, /* in */ int64_t* array, /* in */ uint32_t size);
    int16_t (ECOCALLMETHOD *csort_float)(/* in */ IEcoLab1Ptr_t me, /* in */ float* array, /* in */ uint32_t size);
    int16_t (ECOCALLMETHOD *csort_double)(/* in */ IEcoLab1Ptr_t me, /* in */ double* array, /* in */ uint32_t size);
    int16_t (ECOCALLMETHOD *csort_longdouble)(/* in */ IEcoLab1Ptr_t me, /* in */ long double* array, /* in */ uint32_t size);
